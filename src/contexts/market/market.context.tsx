...
import { validateMarketDataQuery } from "../../utils/validations/market.validations";
import { DEFAULT_MARKET_DATA, MARKET_DATA_TYPES } from "../../utils/constants/market.constants";

import { getStockMarketData, getIndicesMarketData,
  getCryptoMarketData, getForexMarketData
} from "../../utils/api-requests/market.requests";

import { MarketDataQuery, MarketDataQueryResult, MarketData, MarketDataProviderProps, MarketDataContextType } from "./market.types";
...
const searchMarketDataHelper = async (marketDataQuery: MarketDataQuery): Promise<MarketDataQueryResult[] | undefined> => {
  ...
  switch (marketDataQuery.marketDataType) {
    case MARKET_DATA_TYPES.stocks:
      res = await getStockMarketData(marketDataQuery)
      break
